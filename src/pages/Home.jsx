        ...
        <div className='portal-container' style={styles.portalContainer}>
          ...
          <div style={styles.welcomeSection}>
            ...
            <div style={styles.welcomeContent}>
              <a target='blank' href="https://halalcert.com.ng/">
                <img style={styles.logo} src={logo} alt="HDI Logo" />
              </a>
              ...
              <div style={{ ...styles.authLinks, marginTop: '20px', justifyContent: 'center', alignItems: "Center", gap: '20px' }}>
                <a href='https://theyoungpioneers.com/' style={{ textAlign: "center", color: "#ffc107" }}>Developed by VillageCoders</a>
              </div>
            </div>
          </div>
          ...
          <div className='auth-section' style={styles.authSection}>
            ...
            <div
              ...
              id="register-form"
            >
              <h2 style={styles.formTitle}>Signup your account</h2>
