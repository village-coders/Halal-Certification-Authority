  ...
  return (
    <div style={{ background: 'linear-gradient(135deg, #e6f7ff 0%, #f0f9eb 100%)', minHeight: '100vh', padding: '40px 20px', display: 'flex', justifyContent: 'center' }}>
      <div className="guide-content white-card" style={{ maxWidth: '900px', width: '100%', position: 'relative', marginTop: 0 }}>
        ...
        <h1>Halal And Haram Distinction Initiative Development (HDI) - Public User's Guide</h1>
        <p className="intro">Welcome to the <strong>HDI Client Portal</strong>. This guide is designed to help you navigate and fully utilize the portal.</p>
        ...
        <section>
          ...
          <p>Communication with the HDI team is streamlined via the built-in <strong>Messages</strong> system. The <strong>Audits</strong> module is your calendar and record-keeper for onsite and virtual inspections.</p>
        </section>
